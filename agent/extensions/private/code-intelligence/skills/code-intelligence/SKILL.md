...
- Do not use code-intel as a substitute for `gopls`, TypeScript language services, Rust Analyzer, `clangd`, or project-native checks when exact references matter.
