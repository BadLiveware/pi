...
export function registerBrowserBridgeStateTool(pi: ExtensionAPI, runtime: BrowserBridgeRuntime): void {
	pi.registerTool({
		...
		description: "Inspect the local browser bridge server, connected browser clients, activated tabs, pending requests, capabilities, diagnostics, and optional debug log.",
		promptSnippet: "Inspect browser bridge state, connected browser clients, activated tabs, pending requests, capabilities, diagnostics, and optional debug log.",
		promptGuidelines: [
