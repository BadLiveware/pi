...
| `stardock_policy` | Inspect read-only governance policy recommendations. Supports `completion` readiness checks and `auditor` trigger checks without enforcing gates or spawning reviewers. |
