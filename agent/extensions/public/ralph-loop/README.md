...
| `ralph_govern` | Create or reuse a manual governor review request and return its payload. |
...
| `/ralph govern [loop]` | Create or reuse a manual governor review request and show its payload. |
